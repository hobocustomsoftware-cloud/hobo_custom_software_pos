    ...
    <div class="auth-card">
      ...
      <form @submit.prevent="handleLogin" class="space-y-4">
        <div>
          ...
          <input v-model="login" type="text" required class="auth-input login-input auth-input-text block w-full" :placeholder="locale.isEn ? '09xxxxxxxx or email@example.com' : '၀၉xxxxxxxx သို့မဟုတ် အီးမေးလ်'" autocomplete="tel email" />
        </div>
        <div>

...
from .views import UserDetailView, EmployeeViewSet, RoleViewSet, SelectLocationView, RegisterView, ForgotPasswordView, ResetPasswordView, ShopSettingsView, DatabaseStatsView, OutletListView

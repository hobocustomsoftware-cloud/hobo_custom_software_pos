...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'base_unit', 'base_unit_display', 'purchase_unit', 'purchase_unit_display', 'purchase_unit_factor',
            'warranty_months', 'current_stock', 'tags', 'tag_names', 'specifications',
        ]
...
class SaleRequestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['customer', 'sale_items', 'sale_location', 'discount_amount', 'payment_method', 'invoice_number']
    ...
    def create(self, validated_data):
        ...
        with transaction.atomic():
            # ၁။ အရင်ဆုံး Transaction ကို Create လုပ်ပါ
...
class SerialItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SerialItem
        fields = [
            'id', 'product', 'product_name', 'serial_number', 

  ...
  >
    <div class="bg-bg rounded-[12px] shadow-xl border border-border max-w-lg w-full p-6">
      <h3 class="pos-text font-semibold text-fg mb-4" style="font-size: 25px;">
        {{ mode === 'hardware' ? 'ယူနစ်ရွေးချယ်ပါ (ခု/ဒါဇင်/ဖာ/ပေ/မီတာ/ပိတ်သာ)' : 'ယူနစ်ရွေးချယ်ပါ (လုံး/ကဒ်/ဗူး)' }}
      </h3>
...
const props = defineProps({
  ...
  /** Pharmacy = လုံး/ကဒ်/ဗူး. Hardware = ခု/ဒါဇင်/ဖာ/ပေ/မီတာ/ပိတ်သာ with fractional qty */

    ...
    >
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          <h3 :class="['text-2xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-white to-white/50', stat.isAlert ? '!text-rose-300' : '']">
            {{ stat.value }}
          </h3>
          <p class="text-[10px] font-bold text-white/40 mt-1">{{ stat.desc }}</p>
        </div>
      </div>
      ...
      <div class="glass-card rounded-[2rem] overflow-hidden">
        <div class="overflow-x-auto">
          <table class="w-full text-left border-separate border-spacing-0">
            <thead>
              <tr class="text-[10px] font-black text-white/50 uppercase tracking-[0.2em] bg-white/5">
                ...
                <td class="px-6 md:px-8 py-5">
                  <div class="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p class="text-[10px] text-white/50 font-bold mt-1">#{{ prod.sku }}</p>
                    </div>
                  </div>
                </td>
      ...
      <div class="w-full max-w-md rounded-[2rem] p-8 shadow-glow border border-white/20 bg-white/10 backdrop-blur-2xl space-y-6">
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-1">
            ...
            <input v-model="form.quantity" type="number" class="w-full p-4 glass-input text-sm font-bold" />
          </div>
        </div>
        <button
          @click="handleInbound"
...
const openInboundModal = () => {
  form.value = { product: '', to_location: '', quantity: 1, remarks: 'Inbound Entry' }
...
const handleInbound = async () => {
  ...
  try {
    await api.post('movements/inbound/', {
      product: productId,

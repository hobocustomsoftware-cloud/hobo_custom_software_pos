...
from .views import UserDetailView, EmployeeViewSet, RoleViewSet, ShiftViewSet, SelectLocationView, RegisterView, ForgotPasswordView, ResetPasswordView, ShopSettingsView, DatabaseStatsView, OutletListView
